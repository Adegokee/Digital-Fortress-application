...
<form className="max-w-md  w-[70%] mr-[130px]">
  ...
  <button type="submit" className="text-white bg-[#b10d14] hover:bg-gray-200 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Message</button>
</form>
